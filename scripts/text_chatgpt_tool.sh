...
CHAT_INIT_PROMPT="You were trained on data up until 2023. Today's date is $(date +%d/%m/%Y)"

#SYSTEM_PROMPT="You are ChatGPT, a large language model trained by OpenAI. Answer as concisely as possible. Current date: $(date +%d/%m/%Y). Knowledge cutoff: 9/1/2023."
SYSTEM_PROMPT="Current date: $(date +%d/%m/%Y). Knowledge cutoff: 9/1/2023."
